...
### Option 1 — `npx skills add` (권장)

Claude Code, Cursor, Codex, Windsurf 등 skills.sh 호환 에이전트에서 동작.

```bash
npx skills add jazz1x/harnish               # ./.claude/skills/ 에 설치 (프로젝트)
npx skills add jazz1x/harnish -g            # ~/.claude/skills/ 에 설치 (글로벌)
npx skills add jazz1x/harnish --list        # 설치 전 스킬 목록 확인
npx skills add jazz1x/harnish --skill impl  # 단일 스킬만 설치
```
